                            ...
                            value: function (e) {
                                if (this.player.events.trigger("listswitch", {
                                    ...
                                    n && n.classList.remove("aplayer-list-light"),
                                        ...
                                        (0, o.default)(33 * this.index, 500, null, this.player.template.listOl),
                    ...
                    return i(e, [{
                    ...
                    },
                        {
                            ...
                            value: function () {
                                ...
                                this.player.template.barWrap.addEventListener(a.default.nameMap.dragStart,
                                    function () {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.player.template.volumeBarWrap.addEventListener(a.default.nameMap.dragStart,
                                    function () {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.player.template.order.addEventListener("click",
                                    function () {
                                        "list" === e.player.options.order ? (e.player.options.order = "random", e.player.template.order.innerHTML = r.default.orderRandom) :
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.player.template.loop.addEventListener("click",
                                    function () {
                                        e.player.list.audios.length > 1 ? "one" === e.player.options.loop ? (e.player.options.loop = "none", e.player.template.loop.innerHTML = r.default.loopNone) :
                                            ...
                                            "one" === e.player.options.loop || "all" === e.player.options.loop ? (e.player.options.loop = "none", e.player.template.loop.innerHTML = r.default.loopNone) :
                                                "none" === e.player.options.loop && (e.player.options.loop = "all", e.player.template.loop.innerHTML = r.default.loopAll)
                                    })
                            }
                        },
                                ...
                                value: function (e) {
                                    ...
                                    if (!this.parsed[e]) if (this.async) {
                                        ...
                                        n.onreadystatechange = function () {
                                            e === t.player.list.index && 4 === n.readyState && (n.status >= 200 && n.status < 300 || 304 === n.status ? t.parsed[e] = t.parse(n.responseText) : (t.player.notice("LRC file request fails: status " + n.status), t.parsed[e] = [["00:00", "Not available"]]), t.container.innerHTML = (0, r.default)({
                                                lyrics:
                                                    t.parsed[e]
                    ...
                    o = function () {
                        function e(t) {
                            !
                                ...
                                this.data = JSON.parse(r.default.storage.get(this.storageName)),
                            this.data || (this.data = {}),
                        ...
                        return a(e, [{
                        ...
                        },
                            {
                                ...
                                value: function (e, t) {
                                    this.data[e] = t,
                                        r.default.storage.set(this.storageName, JSON.stringify(this.data))
                                }
                            }]),
                            e
                    }();
                ...
                (function (t) {
                    ...
                    a.$escape = function (e) {
                        return function (e) {
                            ...
                            return "string" != typeof t && (t = null == t ? "" : "function" == typeof t ? e(t.call(t)) : JSON.stringify(t)),
                                t
                        }(e))
                    },
                        a.$each = function (e, t) {
                    ...
                    g = function () {
                        ...
                        return i(e, [{
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    this.paused || (this.paused = !0, this.template.button.classList.remove("aplayer-pause"), this.template.button.classList.add("aplayer-play"), this.template.button.innerHTML = "", setTimeout(function () {
                                        ...
                                        100), this.template.skipPlayButton.innerHTML = o.default.play),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    this.volume() >= .95 ? this.template.volumeButton.innerHTML = o.default.volumeUp :
                                        this.volume() > 0 ? this.template.volumeButton.innerHTML = o.default.volumeDown :
